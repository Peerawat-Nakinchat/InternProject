...
export const createAuthRoutes = (deps = {}) => {
  ...
  router.post(
    "/register",
    valMw.validateRegister,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.REGISTER, "USER", {
      severity: "INFO",
      category: "AUTH",
    }),
  ...
  router.post(
    "/login",
    valMw.validateLogin,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.LOGIN, "USER", {
      severity: "INFO",
      category: "AUTH",
    }),
    controller.loginUser,
  );
  // ✅ 2. MFA Verify Route (Fixed Indentation)
  /**
   * @swagger
   * /auth/login/mfa:
   *   post:
  ...
  router.post(
    "/logout",
    authMw.protect,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.LOGOUT, "USER", {
      severity: "INFO",
      category: "AUTH",
    }),
  ...
  router.post(
    "/forgot-password",
    valMw.validateForgotPassword,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.FORGOT_PASSWORD, "USER", {
      severity: "MEDIUM",
      category: "SECURITY",
    }),
  ...
  router.get(
    "/verify-reset-token",
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.VERIFY_RESET_TOKEN, "USER", {
      severity: "MEDIUM",
      category: "SECURITY",
    }),
  ...
  router.post(
    "/reset-password",
    valMw.validateResetPassword,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.RESET_PASSWORD, "USER", {
      severity: "HIGH",
      category: "SECURITY",
    }),
  ...
  router.get(
    "/google",
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.GOOGLE_OAUTH_START, "USER"),
  ...
  router.get(
    ...
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.GOOGLE_OAUTH_CALLBACK, "USER"),
  ...
  router.post(
    "/refresh",
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.REFRESH_TOKEN, "USER", {
      category: "AUTH",
    }),
  ...
  router.post(
    "/token",
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.REFRESH_TOKEN_ALT, "USER", {
      category: "AUTH",
    }),
    refreshMw.refreshAccessToken,
  );
  ...
  router.get(
    "/profile",
    authMw.protect,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.GET_PROFILE, "USER"),
  ...
  router.put(
    ...
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.UPDATE_PROFILE, "USER", {
      severity: "LOW",
      category: "PROFILE",
    }),
  ...
  router.put(
    ...
    authMw.protect,
    auditMw.auditChange("USER", (id) => userModel.findById(id)),
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.CHANGE_EMAIL, "USER", {
      severity: "HIGH",
      category: "SECURITY",
    }),
  ...
  router.put(
    "/change-password",
    authMw.protect,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.CHANGE_PASSWORD, "USER", {
      severity: "MEDIUM",
      category: "AUTH",
    }),
    valMw.validateChangePassword,
  ...
  router.post(
    "/logout-all",
    authMw.protect,
    auditMw.auditLog(AUDIT_ACTIONS.AUTH.LOGOUT_ALL, "USER", {
      severity: "MEDIUM",
      category: "AUTH",
    }),
    controller.logoutAllUser,
  );
  ...
  router.post(
    "/send-otp",
    sendOtpLimiter,
    auditMw.auditLog(AUDIT_ACTIONS.OTP.SEND, "USER", {
      severity: "LOW",
      category: "AUTH",
    }),
    sendOtp,
  ...
  router.post(
    "/verify-otp",
    verifyOtpLimiter,
    auditMw.auditLog(AUDIT_ACTIONS.OTP.VERIFY, "USER", {
      severity: "MEDIUM",
      category: "AUTH",
    }),
    verifyOtp,
  ...
  router.post(
    "/resend-otp",
    resendOtpLimiter,
    auditMw.auditLog(AUDIT_ACTIONS.OTP.RESEND, "USER", {
      severity: "LOW",
      category: "AUTH",
    }),
    resendOtp,
