    ...
    >
      ...
      <template v-for="(items, role) in groupedCompanies" :key="role">
        ...
        <li
          ...
          class="px-4 py-2 bg-[#4A137A] text-white text-sm font-bold cursor-pointer hover:bg-[#5A1F8A] flex justify-between items-center sticky top-0 z-20 transition-colors"
        >
